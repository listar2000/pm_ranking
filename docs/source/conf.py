...
# Exclude certain subfolders from autoapi
autoapi_options = [
    'members',
    'undoc-members',
    'show-inheritance',
...
# AutoAPI configuration for cleaner breadcrumbs
autoapi_python_class_content = 'both'
autoapi_python_use_implicit_namespaces = False

# Try to get cleaner module names by using a different approach
...
# GitHub repository link (appears in top navbar)
html_theme_options = {
    "extra_header_link_icons": {
        "GitHub": {
            "link": "https://github.com/listar2000/pm_ranking",
            "icon": """
